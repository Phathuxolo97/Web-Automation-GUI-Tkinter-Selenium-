...
class App:
    def __init__(self):
        ...
        tk.Button(self.button_frame, text="Submit" , command=self.submit_dat).grid(row=0, column=0, padx=5)
        tk.Button(self.button_frame, text="Close Browser", command=self.close_browse).grid(row=0, column=1, padx=5)
